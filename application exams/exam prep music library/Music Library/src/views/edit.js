...
<div class="form">
  ...
  <form class="edit-form" @submit=${onEdit}>
    <input type="text" name="singer" .value=${offer.singer} id="album-singer" placeholder="Singer/Band" />
    <input type="text" name="album" .value=${offer.album} id="album-album" placeholder="Album" />
    <input type="text" name="imageUrl" .value=${offer.imageUrl} id="album-img" placeholder="Image url" />
    <input type="text" name="release" .value=${offer.release} id="album-release" placeholder="Release date" />
